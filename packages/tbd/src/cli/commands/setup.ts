...
import { stripFrontmatter, insertAfterFrontmatterNoBlank } from '../../utils/markdown-utils.js';
...
class SetupClaudeHandler extends BaseCommand {
  ...
  private async installClaudeSetup(settingsPath: string, skillPath: string): Promise<void> {
    ...
    try {
      ...
      // (no blank line after ---, comment wrapped to multiple lines)
      const markerComment =
        "<!-- DO NOT EDIT: Generated by tbd setup.\nRun 'tbd setup' to update.\n-->";
      skillContent = insertAfterFrontmatterNoBlank(skillContent, markerComment);
